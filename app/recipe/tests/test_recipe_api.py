...
def create_recipe(user, **params):
    """Creat and return sample recipe"""
    defaults = {
...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_recipe_list_limited_to_user(self):
        """Test limited to authenticated user"""
    ...
    def test_create_tag_on_update(self):
        """Test createing tag when updating recipe"""
    ...
    def test_create_recipe_with_new_ingredient(self):
        """Test creating ingredients succeeds"""
        payload = {
    ...
    def test_update_recipe_assign_ingredient(self):
        """Test updating recipe ingredient"""
...
class ImageUploadTests(TestCase):
    ...
    def test_upload_image_fails(self):
